...
- Update LiveKit SDK to 2.26.0 - [#75](https://github.com/livekit/components-android/pull/75) ([@davidliu](https://github.com/davidliu))

## 2.3.0

### Minor Changes

- Update LiveKit SDK to 2.24.1 - [#70](https://github.com/livekit/components-android/pull/70) ([@davidliu](https://github.com/davidliu))

## 2.2.1

### Patch Changes

- Update LiveKit SDK to 2.23.5 - [#67](https://github.com/livekit/components-android/pull/67) ([@davidliu](https://github.com/davidliu))
