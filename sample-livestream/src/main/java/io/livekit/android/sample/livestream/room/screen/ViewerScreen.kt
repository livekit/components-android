...
fun ViewerScreenContainer() {
    RoomScope(
        ...
        ModalBottomSheetLayout(
            ...
            DestinationsNavHost(
                navGraph = NavGraphs.viewer,
                navController = navController,
                engine = navHostEngine,
                dependenciesContainerBuilder = {
                    dependency(NavGraphs.viewer) {
                        RoomLocal.current
                    }
                }
            )
...
fun ViewerScreen(
    ...
    ConstraintLayout(
        ...
        RoomControls(
            ...
            onFlipButtonClick = {},
            onAspectButtonClick = {},
            onParticipantButtonClick = { navigator.navigate(ViewerParticipantListScreenDestination()) },
